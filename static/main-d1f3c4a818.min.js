...
(function epicHello() {
  ...
  if (supported.test(userAgent.toLowerCase())) {
      var dark = ['padding: 20px 5px 16px', 'background-color: #171718', 'color: #bc994e', ].join(';');
      ...
      var gold = ['padding: 20px 5px 16px', 'background-color: #bc994e', 'color: #ffffff', ].join(';');

      var spacer = ['background-color: transparent', ].join(';');

      var msg = '\n\n %c Curated by Maina Githinji %c https://mgithinji.xyz %c \n\n\n';

      console.log(msg);
  } else if (window.console) {
      console.log('Curated by Maina Githinji - https://mgithinji.xyz');
  }
}());
!function(e) {
  function t(t) {
      for (var i, r, a = t[0], l = t[1], u = t[2], h = 0, d = []; h < a.length; h++)
          r = a[h],
          s[r] && d.push(s[r][0]),
          s[r] = 0;
      for (i in l)
  ...
  const o = new class {
      ...
      onTick(e) {
          this.time = e,
          this.isPaused || (this.delta = (e - this.oldTime) / 1e3,
          this.oldTime = e,
          i.b.trigger({
              name: "raf"
          }, {
  ...
  const a = new class extends (Object(i.a)()) {
      init() {
          this.readAndUpdatePage = this.readAndUpdatePage.bind(this),
          this.whenScroll = this.whenScroll.bind(this),
          this.whenScroll(),
          this.speed = 0,
          this.speed2 = 0,
          this.oldY = this.y,
          ...
          this.height = 0,
          this.easeY = this.y,
          this.parallaxEasedY = this.y,
          this.wrapper = document.querySelector(".site"),
          this.vs && this.enablevs(),
      ...
      onLoadEnd() {
          ...
          this.oldY = 0,
          this.easeY = 0,
          this.parallaxEasedY = 0,
          window.scrollTo(0, 0),
          l.onResize(),
          s.a.boarding || (this.vslocked = !1)
      }
      onVisibilitychange({hidden: e}) {
          e || (this.oldY = this.y,
          this.easeY = this.y,
          this.parallaxEasedY = this.y,
          this.speed = 0,
      ...
      onResize() {
          this.vs && (this.height = this.wrapper.clientHeight,
          this.fakeScroll.style.height = `${this.height}px`)
      }
      enablevs() {
          this.vs = !0,
          this.fakeScroll = document.createElement("div"),
          this.wrapper.classList.add("vs"),
      ...
      whenScroll() {
          ...
          this.x = (window.pageXOffset || e.scrollLeft) - (e.clientLeft || 0),
          this.y = window.pageYOffset || document.documentElement.scrollTop,
          this.progressY = this.y / (t - n),
          i.b.trigger({
              name: "scroll",
              fireAtStart: !0
          }, {
          ...
          this.scheduledAnimationFrame || (this.scheduledAnimationFrame = !0,
          requestAnimationFrame(this.readAndUpdatePage))
      }
      onRaf({delta: e}) {
          const t = this.oldY - this.y;
          this.speedTarget = .2 * Object(r.clamp)(0, 3, Math.abs(t)),
          this.speedTarget2 = .2 * Object(r.clamp)(-3, 3, t),
          this.oldY = this.y,
          this.speed = Object(r.lerp)(this.speed, this.speedTarget, 2 * e),
          this.speed2 = Object(r.lerp)(this.speed2, this.speedTarget2, 2 * e),
          this.easeY = Object(r.lerp)(this.easeY, this.y, 5 * e),
          this.parallaxEasedY = Object(r.lerp)(this.parallaxEasedY, this.y, 4 * e),
          this.vs && !this.vslocked && setTimeout(()=>{
              const e = Math.round(100 * this.easeY) / 100;
              this.wrapper.style.transform = `translate3d(0px, -${e}px, 0px)`,
              this.fixedContainer && (this.fixedContainer.style.transform = `translate3d(0px, ${e}px, 0px)`)
          }
          , 0)
      }
  }
  ...
  const l = new class {
      constructor() {
          ...
          this.onResize(),
          window.addEventListener("resize", function(e, t, n) {
              var i;
              return function() {
                  var s = this
                    , o = arguments
  ...
  const h = new class {
      constructor() {
          ...
          this.isTouching = !0,
          this.distance = 0,
          this.hold = new u.Vector2,
          this.last = new u.Vector2,
          this.delta = new u.Vector2,
          this.move = new u.Vector2,
          this.world = new u.Vector3,
          this.normalized = new u.Vector2,
          this._tmp = new u.Vector3,
          this.bind()
      }
      bind() {
          const e = window;
      ...
      convertEvent(e) {
          ...
          return e ? e.windowsPointer ? e : (e.touches || e.changedTouches ? e.touches.length ? (t.x = e.touches[0].clientX,
          t.y = e.touches[0].clientY) : (t.x = e.changedTouches[0].clientX,
          t.y = e.changedTouches[0].clientY) : (t.x = e.clientX,
          t.y = e.clientY),
          t.x = Object(r.clamp)(0, l.width, t.x),
          t.y = Object(r.clamp)(0, l.height, t.y),
          t) : t
      }
      onStart(e) {
          ...
          this.x = t.x,
          this.y = t.y,
          this.hold.set(t.x, t.y),
          this.last.set(t.x, t.y),
          this.delta.set(0, 0),
          this.move.set(0, 0),
          this.normalized.x = this.x / l.width * 2 - 1,
          this.normalized.y = -this.y / l.height * 2 + 1,
          this.distance = 0,
          i.b.trigger({
              name: "pointerStart"
          }, {
      ...
      onMove(e) {
          const t = this.convertEvent(e);
          this.isTouching && (this.move.x = t.x - this.hold.x,
          this.move.y = t.y - this.hold.y),
          this.x = t.x,
          this.y = t.y,
          ...
          this._tmp.z = .5,
          this._tmp.unproject(c.a);
          const n = this._tmp.sub(c.a.position).normalize()
            , s = -c.a.position.z / n.z;
          this.world.copy(c.a.position).add(n.multiplyScalar(s)),
          i.b.trigger({
              name: "pointerMove"
          }, {
              pointer: this
...
, , , function(module, __webpack_exports__, __webpack_require__) {
  ...
  "Internet Explorer" !== device.browser.name && "Microsoft Edge" !== device.browser.name || (settings.boarding = !1,
  settings.dom = !1),
  "Internet Explorer" === device.browser.name && document.documentElement.classList.add("show-notsupported");
  for (const k in settings) {
      const re = new RegExp(`${k}=(.+?);`)
        , match = search.match(re);
      match && (settings[k] = eval(match[1]))
  }
  settings.dom || document.documentElement.classList.add("static"),
...
, , , function(e, t, n) {
  ...
  t.a = new class {
      ...
      init() {}
      texReady(e) {
          e.anisotropy = o.a.capabilities.getMaxAnisotropy(),
          e.needsUpdate = !0;
          const t = l.clone();
          t.uniforms = {
              uTexture: {
      ...
      fromAsset(e, t={}) {
          ...
          for (const n in t)
              this.textures[e][n] = t[n];
          return s.a.resources[e].loading.then(t=>{
              this.textures[e].image = t.meta.data,
              this.texReady(this.textures[e])
          }
          ),
          this.textures[e]
      }
      fromImg(e, t={}) {
          ...
          this.textures[n] = new i.Texture,
          this.textures[n].image = e;
          for (const e in t)
              this.textures[n][e] = t[e];
...
, function(e, t, n) {
  ...
  var m = class extends (Object(s.a)(i.Object3D)) {
      init() {
          this.geometry = new i.PlaneBufferGeometry(1,1,1,1),
          ...
          this.logo = new i.Mesh(this.geometry,this.material),
          this.logo.position.z = 3,
          this.add(this.logo),
          this.textMaterial = this.material.clone(),
          this.textMaterial.uniforms = {
              uTexture: {
                  value: l.a.fromAsset("boardingLogo")
              },
              uNoise: {
          ...
          this.textMaterial.uniforms.uTexture.value = l.a.fromAsset("boardingText"),
          this.text = new i.Mesh(this.geometry,this.textMaterial),
          this.text.position.z = 3,
          this.add(this.text),
          this.glitchGeometry = new i.PlaneBufferGeometry(1,1,1,1),
          this.glitchMaterial = new i.RawShaderMaterial({
          ...
          this.glitchMesh = new i.Mesh(this.glitchGeometry,this.glitchMaterial),
          this.glitchMesh.position.z = 2.9,
          this.add(this.glitchMesh)
      }
      onLoadEnd() {
          d.style.opacity = 0;
          ...
          e.fromTo(this.logo.position, 3, {
              y: -t
          }, {
              y: t,
              ease: o.SlowMo.ease.config(.1, .1, !1)
          }),
          ...
          , 1.7),
          e.add("text", 2.2),
          e.set(this.textMaterial.uniforms.uOpacity, {
              value: 1
          }, "text"),
          e.fromTo(this.text.position, 3, {
              y: -t
          }, {
              y: t,
              ease: o.SlowMo.ease.config(.1, .9, !1)
          }, "text"),
          e.fromTo(this.textMaterial.uniforms.uForce, 3, {
              value: 1
          }, {
              value: 0,
              ease: "Power4.easeOut"
          ...
          , "fadeout"),
          e.to(this.glitchMaterial.uniforms.uOpacity, .8, {
              value: 0,
          ...
          if (r.c.width <= 10 && n) {
              const t = n.querySelectorAll(".line span")
                , i = document.querySelectorAll(".nav__logo, .nav__list__first li, .nav__toggler")
              ...
              f.material.uniforms.uClipping.value = 0,
              o.TweenMax.set([t, s], {
                  yPercent: 100
              }),
              o.TweenMax.set(i, {
              ...
              e.add(()=>{
                  ...
                  e.staggerFromTo([r, l], 2, {
                      width: "0%"
                  }, {
                      width: "100%",
                      ease: "Power4.easeInOut"
                  }, .1, .3),
                  e.staggerFromTo([a, u, h], 2, {
                      height: "0%"
                  }, {
                      height: "100%",
                      ease: "Power4.easeInOut"
                  }, .1, .3),
                  e.fromTo(f.material.uniforms.uClipping, 1, {
                      value: 0
                  }, {
                      value: 1,
                      ease: "Power4.easeOut"
      ...
      onResize() {
          ...
          this.logoCam = e,
          this.logo.scale.x = .6 * e.width,
          this.logo.scale.y = this.logo.scale.x / 2,
          this.text.scale.copy(this.logo.scale);
          const t = a.a.calculateUnitSize(a.a.position.z - this.glitchMesh.position.z);
          this.glitchMesh.scale.x = t.width,
          this.glitchMesh.scale.y = this.glitchMesh.scale.x / (1680 / 1507),
          this.glitchMesh.position.y = t.height / 2 - this.glitchMesh.scale.y / 2
      }
      onRaf({delta: e}) {
          this.visible && (this.glitchMaterial.uniforms.uTime.value += e,
          this.glitchMaterial.uniforms.uUv.value = h.a.target)
      }
  }
    , p = n(11)
    , v = n(15)
  ...
  class g extends (Object(s.a)(i.Object3D)) {
      init() {
          ...
          for (let t = 0; t < 1024; t += 4)
              e[t + 0] = Object(p.randomFloat)(-5, 5),
              e[t + 1] = Object(p.randomFloat)(-5, 5),
              e[t + 2] = Object(p.randomFloat)(-5, 5),
              e[t + 3] = Object(p.randomFloat)(0, 4);
          for (let e = 0; e < 256; e++)
              t[e] = e / 256;
          this.geometry.addAttribute("position", new i.BufferAttribute(t,1)),
          this.fbo = new v.a({
              data: e,
              width: 256,
              height: 1,
          ...
          this.rt = new i.WebGLRenderTarget(512,512,{}),
          ...
          this.plane = new i.PlaneBufferGeometry(1,1,1,1),
          this.viewerMaterial = new i.RawShaderMaterial({
          ...
          this.viewer = new i.Mesh(this.plane,this.viewerMaterial),
          this.add(this.viewer),
          this.viewer.position.z = -1
      }
      onResize() {
      ...
      draw({delta: e}) {
          this.fbo.uniforms.uTime.value += e,
          this.fbo.uniforms.uSpeed.value = r.b.speed2,
          this.fbo.update(),
          this.material.uniforms.uTime.value += e,
          this.material.uniforms.uData.value = this.fbo.target,
          f.a.setRenderTarget(this.rt),
          f.a.render(this.scene, a.a),
          f.a.setRenderTarget(null),
          this.buffer.uniforms.uSpeed.value = r.b.speed2,
          this.buffer.update(),
          this.viewerMaterial.uniforms.uTexture.value = this.buffer.target
      }
      onRaf({delta: e}) {
          this.viewerMaterial.uniforms.uTime.value += e,
          this.draw({
              delta: e
          })
      }
  ...
  t.a = new class extends (Object(s.a)(i.Scene)) {
      init() {
          this.background = new i.Color(277),
          x.a.boarding && this.add(new m),
          x.a.particles && this.add(new g),
          this.add(a.a)
      }
  }
}
, function(e, t, n) {
  ...
  t.a = new class extends (Object(s.a)(i.PerspectiveCamera)) {
      ...
      init() {
          ...
          this.lookAt(new i.Vector3(0,0,0)),
          l.a.orbit && this.initOrbitControl()
      }
      initOrbitControl() {
...
, function(e, t, n) {
  ...
  t.a = new class extends (Object(s.a)()) {
      init() {
          this.renderer = r.a,
          this.scene = new i.Scene,
          this.dummyCamera = new i.Camera,
          this.resolution = new i.Vector2,
          this.renderer.getDrawingBufferSize(this.resolution),
          this.target = new i.WebGLRenderTarget(this.resolution.x,this.resolution.y,{
              format: i.RGBFormat,
              stencilBuffer: !1,
              depthBuffer: !0
          }),
          this.target.texture.wrapS = i.RepeatWrapping,
          this.target.texture.wrapT = i.RepeatWrapping;
          const e = {};
          a.a.fxaa && (e.FXAA = !0),
          this.material = new i.RawShaderMaterial({
              defines: e,
          ...
          this.triangle = new i.Mesh(l.a,this.material),
          this.triangle.frustumCulled = !1,
          this.scene.add(this.triangle),
          this.timer = 0
      }
      setSmallGlitch(e, t=.0) {
          const n = e.getBoundingClientRect()
            , i = n.width / o.c.width
            , s = n.height / o.c.height;
          this.material.uniforms.uRectSmall.value.set(n.left / o.c.width - t, 1 - n.bottom / o.c.height - t, n.left / o.c.width + i + t, 1 - n.bottom / o.c.height + s + t),
          this.material.uniforms.uSmallGlitch.value = 1
      }
      resetSmallGlitch() {
          this.material.uniforms.uRectSmall.value.setScalar(0),
          this.material.uniforms.uSmallGlitch.value = 0
      }
      onResize() {
          this.renderer.getDrawingBufferSize(this.resolution),
      ...
      onRaf({delta: e}) {
          this.timer += e,
          this.material.uniforms.uTime.value += .1 * e,
          this.material.uniforms.uTrail.value = u.a.fbo.target,
          this.material.uniforms.uSpeed.value = o.b.speed
      }
  }
}
, , function(e, t, n) {
...
, function(e, t, n) {
  ...
  t.a = new class extends (Object(i.a)()) {
      init() {
          ...
          this.speed = 0,
          this.pointerTarget = new r.Vector2
      }
      onResize({ratio: e}) {
          this.fbo.uniforms.uRatio.value = e
      }
      onPointerMove({pointer: e}) {
          this.pointerTarget.set(e.x / window.innerWidth, 1 - e.y / window.innerHeight)
      }
      onRaf({delta: e}) {
          this.fbo.uniforms.uPrevPointer.value.copy(this.fbo.uniforms.uPointer.value),
          this.fbo.uniforms.uPointer.value.lerp(this.pointerTarget, .2),
...
, , function(e, t, n) {
  ...
  class c {
      constructor({width: e, height: t, data: n, name: o, shader: u, texture: c, uniforms: h={}, rtOptions: d={}, debug: m=!1}) {
          ...
          this.index = 0,
          this.copyData = !0,
          this.texture = c || new i.DataTexture(n || new Float32Array(e * t * 4),e,t,i.RGBAFormat,i.FloatType),
          ...
          this.mesh.frustumCulled = !1,
          this.scene.add(this.mesh),
          this.options.debug && this.initDebug()
      }
      initDebug() {
          this.debugGeometry = new i.PlaneBufferGeometry(2,2),
          this.debugMaterial = new i.MeshBasicMaterial({
              map: this.target
          }),
          this.debugMesh = new i.Mesh(this.debugGeometry,this.debugMaterial),
          this.debugMesh.position.set(0, 0, -5),
          o.a.add(this.debugMesh)
      }
      createRT() {
      ...
      resize(e, t) {
          this.material.defines.RESOLUTION = `vec2(${e.toFixed(1)}, ${t.toFixed(1)})`,
...
, , function(e, t, n) {
  ...
  var i = n(0)
    ...
    , a = n(9)
    , l = (n(11),
  class extends (Object(o.a)(i.Object3D)) {
      init() {
          this.element = this._args[0],
          this.isFixed = this.element.dataset.fixed,
          this.speed = parseFloat(this.element.dataset.parallax),
          this.isParallax = !!this.speed,
          this.track = !0,
          this.parallaxmid = this.element.dataset.parallaxmid
      }
      onResize() {
          if (!this.track)
              return;
          ...
          this.isFixed || (this.bounds.top += r.b.vs ? r.b.easeY : r.b.y),
          this.updateSize(),
          this.updatePosition()
      }
      updateSize() {
          ...
          e && t && (this.scale.x = this.camUnit.width * e,
          this.scale.y = this.camUnit.height * t)
      }
      updatePosition(e=(r.b.vs ? r.b.easeY : r.b.y)) {
          ...
          this.position.x += this.bounds.left / r.c.width * this.camUnit.width,
          this.position.y -= (this.bounds.top - t) / r.c.height * this.camUnit.height
      }
      updateParallax(e) {
          if (!(r.c.width <= 10))
              if (this.parallaxmid) {
                  ...
                  this.position.y += e * (2e-4 * this.speed) * this.camUnit.height
      }
      onRaf() {
          this.track && !r.b.vslocked && (this.updatePosition(r.b.easeY),
          this.isParallax && this.updateParallax(r.b.parallaxEasedY))
      }
      destroy() {
          this.parent && this.parent.remove(this),
          this.visible = !1,
  ...
  const k = {
      button: class extends l {
          init() {
              ...
              this.position.z += .01,
              this.element.classList.contains("nav__button") ? this.material.uniforms.uShow.value = 0 : (m.a.history.previous || this.onEnterAnim(),
              m.a.hooks.after(()=>this.onEnterAnim()),
              m.a.hooks.before(()=>this.onLeaveAnim()))
          }
          onEnterAnim() {
              this.enter || (this.enter = !0,
              s.TweenMax.to(this.material.uniforms.uShow, .6, {
                  value: 1,
                  ease: "Power4.easeOut"
              }))
          }
      ...
      person: class extends l {
          init() {
              ...
              m.a.history.previous || this.onEnterAnim(),
              m.a.hooks.after(()=>this.onEnterAnim()),
              m.a.hooks.before(()=>this.onLeaveAnim())
          }
          onEnterAnim() {
          ...
          onResize() {
              ...
              this.material.uniforms.uRectSize.value.set(this.bounds.width, this.bounds.height),
              this.material.uniforms.uImageSize.value.set(e.image.naturalWidth, e.image.naturalHeight)
          }
          onRaf({delta: e}) {
              super.onRaf(),
              this.material.uniforms.uTime.value += .1 * e
      ...
      cover: class extends l {
          init() {
              ...
              if (t) {
                  ...
                  this.material.uniforms.uMask.value = c.a.fromImg(e),
                  e.src = t
              }
              this.mesh = new i.Mesh(this.geometry,this.material),
              this.position.z -= .02,
              ...
              u.a.add(this),
              m.a.hooks.after(()=>this.onEnterAnim()),
              m.a.hooks.leave(()=>this.onLeaveAnim())
          }
          onEnterAnim() {
              this.enter || (this.enter = !0,
              s.TweenMax.to(this.material.uniforms.uProgress, 15, {
                  value: 1,
                  ease: "Power4.easeOut"
              }))
          }
      ...
      footer: class extends l {
          ...
          onEnterAnim() {
              this.enter || (this.enter = !0,
              TweenMax.to(this.material.uniforms.uShow, .6, {
                  value: 1,
                  ease: "Power4.easeOut"
              }))
          }
      ...
      date: class extends l {
          init() {
              ...
              this.add(this.mesh),
              u.a.add(this),
              m.a.history.previous || this.enterAnim(),
              m.a.hooks.after(()=>this.enterAnim()),
              m.a.hooks.leave(()=>this.leaveAnim())
          }
          enterAnim() {
              this.enter || (this.enter = !0,
              s.TweenMax.to(this.material.uniforms.uProgress, 15, {
      ...
      line: class extends l {
          init() {
              ...
              this.mesh = new i.Mesh(this.geometry,this.material),
              this.scale.set(.01, .01, 1),
              this.add(this.mesh),
              u.a.add(this),
              window.setTimeout(this.bind.bind(this), 200)
          }
          bind() {
          ...
          onLeave(e) {
              e && (s.TweenMax.killTweensOf([this.position, this.scale]),
              s.TweenMax.to(this.scale, .3, {
                  y: .001,
                  ease: "Power4.easeInOut",
                  onComplete: ()=>{
                      this.visible = !1
      ...
      listhover: class extends l {
          ...
          onEnter(e, t) {
              ...
              M.a.fbo.uniforms.uRect.value.set(o, i, o + l, i + a),
              M.a.fbo.uniforms.uRectForce.value = 1,
              s.TweenMax.to(M.a.fbo.uniforms.uRectForce, .3, {
                  value: 0
              }),
              ...
              this.material.uniforms.uTextureB.value = this.textures[u],
              this.material.uniforms.uTextureA.value !== this.material.uniforms.uTextureB.value && (s.TweenMax.killTweensOf([this.uProgress]),
              s.TweenMax.fromTo(this.material.uniforms.uProgress, .5, {
                  value: 0
              }, {
                  value: 1,
                  ease: "Power4.easeOut",
              ...
              s.TweenMax.killTweensOf([this.position, this.scale]),
              this.visible ? s.TweenMax.to(this.position, .5, {
                  x: e.position.x,
                  y: e.position.y,
                  z: e.position.z,
                  ease: "Power4.easeOut"
      ...
      glitch: class extends l {
          init() {
              ...
              this.mesh = new i.Mesh(this.geometry,this.material),
              this.position.z = -5,
              this.parallaxmid && (this.position.z = -6),
              this.onResize(),
              this.add(this.mesh),
              u.a.add(this)
          }
          onResize() {
              super.onResize(),
              this.material.uniforms.uScreen.value.set(r.c.width, r.c.height)
          }
          onRaf({delta: e}) {
              super.onRaf(),
              this.material.uniforms.uTime.value += e,
              this.material.uniforms.uUv.value = this.fbo.target,
              this.material.uniforms.uScroll.value = r.b.parallaxEasedY
          }
      }
      ,
  ...
  t.a = new class {
      constructor() {
          ...
          r.forEach(e=>{
              ...
              this.resources[e.name].loading = o()
          }
          )
      }
      load() {
          return this.deferred = o(),
          this.loader = new i.Loader,
          s.b.trigger({
              name: "loadStart"
          }),
          r.forEach(e=>{
...
, function(e, t, n) {
  ...
  a.b.on("raf", ({delta: e})=>{
      l.uniforms.uTrail.value = r.a.fbo.target,
      l.uniforms.uTime.value += e,
      l.update()
  }
  ),
  t.a = l
...
, , , , , , , , , function(e, t, n) {
  ...
  o.addAttribute("position", new i.BufferAttribute(s,2)),
  t.a = o
}
, , , , , , , , , , , , , , , , , , function(e, t, n) {
  "use strict";
...
, , , , , function(e, t, n) {
  ...
  var i = n(5)
    ...
    , o = function(e, t, n, i, s, o) {
      ...
      return document.cookie = encodeURIComponent(e) + "=" + encodeURIComponent(t) + r + (s ? "; domain=" + s : "") + (i ? "; path=" + i : "") + (o ? "; secure" : ""),
      !0
  }
    , r = function(e) {
  ...
  t.default = class extends i.Component {
      init() {
          if (r("accepted"))
              ...
              this.$el.querySelector(".cookiebar__close").addEventListener("click", this.close.bind(this)),
              l.a.hooks.leave(()=>this.close())
          }
      }
      hide() {
          this.hided = !0,
...
, , function(e, t, n) {
  ...
  var s = {
    ...
    , l = n(5);
  function u(e, t) {
      if (e.parentNode && "function" == typeof e.parentNode.matches)
          return e.parentNode.matches(t) ? e.parentNode : u(e.parentNode, t)
  }
  function c(e, t, n, i) {
      !function(e, t, n, i) {
  ...
  class p {
      constructor() {
          ...
          c(document.body, "[data-open-popup]", "click", this.open),
          c(document.body, ".popup__close", "click", this.close),
          c(document.body, ".popup__layer", "click", this.close),
      ...
      open(e, t=!1) {
          ...
          l.to(u, 1.2, {
              ...
              onUpdate: ()=>{
                  ...
                  o.style.clipPath = e,
                  o.style.webkitClipPath = e,
                  o.style.transform = `translateZ(${c++}px)`
              }
          }, 0),
          l.from(r, 2.2, {
              opacity: 0,
      ...
      close(e) {
          ...
          s.to(a, 1, {
              ...
              onUpdate: ()=>{
                  ...
                  i.style.clipPath = e,
                  i.style.webkitClipPath = e,
                  i.style.transform = `translateZ(${l++}px)`
              }
          }, 0),
          s.to(n, 1, {
              opacity: 0
  ...
  var f = new class {
      ...
      playHover() {
          const e = +new Date;
          this.lastHover && e - this.lastHover < 200 || (this.lastHover = e,
          this.hovers[Math.floor(Math.random() * this.hovers.length)].play())
      }
  }
    , g = n(6)
    , x = n.n(g)
  ...
  const b = (()=>{
      let e = !1;
      return window.CSS && window.CSS.supports && (e = window.CSS.supports("clip-path", "polygon(0 25%, 100% 25%, 100% 30%, 0 30%)")),
      e
  }
  )();
  var T = {
      ...
      before({current: e, next: t}) {
          h.b.fixedContainer = t.container,
      ...
      enter({current: e, next: t}) {
          ...
          i.add(()=>{
              ...
              b ? (e.container.classList.add("glitch1"),
              t.container.classList.add("glitch2")) : (e.container.classList.add("flash1"),
              t.container.classList.add("flash2")),
              f.transition[0].play()
          }
          ),
          i.add(()=>{
          ...
          , 1.3),
          i.to(w.a.material.uniforms.uGlitch, .2, {
              value: 1
          }),
          ...
          i.add(()=>{
              w.a.material.uniforms.uGlitch.value = 0,
              t.container.classList.remove("glitch2"),
              t.container.classList.remove("flash2"),
      ...
      after({next: e}) {
          ...
          h.b.fixedContainer && (h.b.fixedContainer.style.transform = ""),
          h.b.fixedContainer = null,
          h.b.oldY = 0,
          h.b.y = 0,
          h.b.easeY = 0,
          h.b.parallaxEasedY = 0,
          window.scrollTo(0, 0),
          h.b.vslocked = !1,
          h.b.unlock(),
          window.setTimeout(()=>{
  ...
  var S = {
    ...
    , O = ()=>{
      x.a.init({
          transitions: [T, S],
          prevent: ({el: e})=>!!window.EPICINFO.WPBAR && u(e, "#wpadminbar")
      }),
  ...
  const L = new class extends l.CustomEvent {
      constructor(...e) {
          ...
          this.elementsByObserver = new l.Multimap,
      ...
      bind(e, t, n) {
          ...
          this.onceByElement.set(i, s.once),
          this.eventByElement.set(i, this.callback(e)),
          o.observe(i)
      }
      createObserver(e, t) {
          const n = this.getObserverByOptions(e);
          if (n)
              return this.getObserverByElement(t) || this.addObserver(n, t),
              n;
          const i = new IntersectionObserver(this.intersected.bind(this),e);
          return this.addObserver(i, t),
          i
      }
      ...
      addObserver(e, t) {
          ...
          this.elementsByObserver.add(e, t)
      }
      removeObserver(e, t) {
          this.elementsByObserver.delete(e, t),
          0 === this.elementsByObserver.getValuesForKey(e) && this.observers.delete(e)
      }
      unobserve(e) {
          const t = this.getObserverByElement(e);
          t && t.unobserve(e),
          this.removeObserver(t, e)
      }
      unbind(e) {
      ...
      intersected(e) {
          e.forEach(e=>{
              ...
              let r = "center";
              s ? r = "top" : o && (r = "bottom"),
              this.eventByElement.get(t)(n, i, r),
              n && this.onceByElement.get(t) && this.unobserve(t)
          }
          )
      }
      callback(e) {
  ...
  new class extends l.CustomEvent {
      ...
      bind(e, t) {
          ...
          this.ee = t,
          this.eventByElement.set(n, this.callback(e)),
          this.ee.on("raf", this.eventByElement.get(n)),
          this.onTick = this.onTick.bind(this),
          this.time = window.performance.now(),
          this.raf = window.requestAnimationFrame(this.onTick)
      }
      unbind(e, t) {
          t.off("raf", this.eventByElement.get(e.context.element)),
          window.cancelAnimationFrame(this.raf)
      }
      onTick(e) {
          this.time = e,
          this.delta = (e - this.oldTime) / 1e3,
          this.oldTime = e,
          this.ee.emit("raf", this.delta, e),
          this.raf = window.requestAnimationFrame(this.onTick)
      }
      callback(e) {
          return function(t, n) {
  ...
  new class extends l.CustomEvent {
      ...
      bind(e, t) {
          const n = e.context.element;
          this.eventByElement.set(n, this.callback(e, t)),
          window.addEventListener("resize", this.eventByElement.get(n))
      }
      unbind(e) {
          const t = e.context.element;
  ...
  new class extends l.CustomEvent {
      ...
      bind(e) {
          const t = e.context.element;
          this.eventByElement.set(t, this.callback(e)),
          window.addEventListener("scroll", this.eventByElement.get(t))
      }
      unbind(e) {
          const t = e.context.element;
  ...
  class U {
      ...
      init() {
          ...
          "Internet Explorer" !== e && "Microsoft Edge" !== e && O(),
          new p;
          try {
              const e = n(66)
                , t = l.Application.start(document.body);
              t.use("appear", L),
              t.load(Object(l.autoLoad)(e))
          } catch (e) {}
          U.showPage()
      }
  }
  ...
  t.default = class extends i.Component {
      init() {
          this.instance = new class extends (Object(s.a)()) {
              init() {
                  this.card = this._args[0].querySelector(".ticket__cta"),
                  this.shadow = this._args[0].querySelector(".ticket__cta__shadow"),
                  this.force = Object(a.randomFloat)(.6, 1)
              }
              onRaf({delta: e}) {
                  const t = 50 * r.b.speed2 * this.force;
                  this.card.style.transform = `rotateX(${t}deg)`,
                  this.shadow.style.opacity = Math.min(1, Math.pow(r.b.speed, 2))
              }
          }
          (this.$el),
          this.enter = this.enter.bind(this),
          this.$refs.cta.addEventListener("mouseenter", this.enter)
      }
      destroy() {
...
, function(e, t, n) {
  ...
  t.default = class extends i.Component {
      init() {
          ...
          this.close = this.close.bind(this),
          r.a.boarding && r.a.dom ? s.b.on("boardingEnd", this.show) : window.setTimeout(this.show, 500),
          document.addEventListener("keyup", e=>{
              27 === e.keyCode && this.close(e)
          }
          ),
          this.$refs.close.addEventListener("click", this.close),
          this.$refs.layer.addEventListener("click", this.close)
      }
      show() {
          this.isAnimating = !0,
          this.isOpen = !0;
          ...
          e.to(t, 1.2, {
              ...
              onUpdate: ()=>{
                  ...
                  this.$refs.panel.style.clipPath = e,
                  this.$refs.panel.style.webkitClipPath = e,
                  this.$refs.panel.style.transform = `translateZ(${n++}px)`
              }
          }, 0),
          e.from(this.$refs.right, 2.2, {
              opacity: 0,
              y: 200,
              ease: "Power4.easeOut"
          }, 0),
      ...
      close(e) {
          ...
          i.to(a, 1, {
              ...
              onUpdate: ()=>{
                  const e = `polygon(${a.p1x}% ${a.p1y}%, ${a.p2x}% ${a.p2y}%, ${a.p3x}% ${a.p3y}%, ${a.p4x}% ${a.p4y}%)`;
                  n.style.clipPath = e,
                  n.style.webkitClipPath = e,
                  n.style.transform = `translateZ(${l++}px)`
              }
          }, 0),
          i.to(t, 1, {
              opacity: 0
...
, function(e, t, n) {
  ...
  t.default = class extends i.Component {
      init() {
          s.a.dom ? (this.lines = this.$el.querySelectorAll(".line span"),
          this.hasLines = this.lines.length,
          this.optionsAppear = {
              once: !0,
              threshold: [.5, 1],
...
, function(e, t, n) {
  ...
  t.default = class extends i.Component {
      init() {
          this.programMouseEnter = this.programMouseEnter.bind(this),
          this.programMouseLeave = this.programMouseLeave.bind(this),
          this.$refs.program.addEventListener("mouseenter", this.programMouseEnter),
          this.$refs.program.addEventListener("mouseleave", this.programMouseLeave),
          a.a.hooks.leave(()=>this.programMouseLeave()),
          a.a.hooks.after(e=>this.handleAnchor(e.next.container)),
          l.b.on("loadEnd", this.onLoadEnd.bind(this)),
          l.b.on("boardingEnd", this.onLoadEnd.bind(this)),
      ...
      programMouseEnter() {
          ...
          e.to(i, 1.2, {
              ...
              onUpdate: ()=>{
                  ...
                  t.style.clipPath = e,
                  t.style.webkitClipPath = e
              }
          }, 0),
          e.staggerFromTo(n, 1.7, {
              y: 30
          }, {
              y: 0,
              ease: "Power4.easeOut"
...
, function(e, t, n) {
  ...
  t.default = class extends i.Component {
      init() {
          ...
          this.$refs.toggler.addEventListener("click", this.toggle.bind(this)),
          this.$refs.layer.addEventListener("click", this.close.bind(this)),
          this.$refs.programbigitem.addEventListener("click", this.toggleEvent.bind(this)),
          document.addEventListener("keyup", e=>{
              27 === e.keyCode && this.close(e)
          }
          ),
      ...
      open(e) {
          ...
          t.to(i, 1.15, {
              ...
              onUpdate: ()=>{
                  ...
                  n.style.clipPath = e,
                  n.style.webkitClipPath = e,
                  n.style.transform = `translateZ(${o++}px)`
              }
          }, 0);
      ...
      close(e, t=!1) {
          ...
          if (!this.isOpen)
              return;
          this.eventsOpen && this.closeEvent(),
          this.isAnimating = !0;
          ...
          n.to(o, 1.15, {
              ...
              onUpdate: ()=>{
                  ...
                  i.style.clipPath = e,
                  i.style.webkitClipPath = e,
                  i.style.transform = `translateZ(${r++}px)`
              }
          }, 0)
      }
      toggleEvent(e) {
          e && e.preventDefault(),
          e && e.stopPropagation(),
          this[this.eventsOpen ? "closeEvent" : "openEvent"]()
      }
      openEvent(e) {
          e && e.preventDefault(),
          e && e.stopPropagation(),
          s.TweenMax.killTweensOf(this.$refs.events),
          s.TweenMax.set(this.$refs.events, {
              height: "auto"
          }),
          ...
          this.$refs.programbigitem.classList.add("active"),
          this.eventsOpen = !0
      }
      closeEvent(e) {
          e && e.preventDefault(),
          s.TweenMax.killTweensOf(this.$refs.events),
          s.TweenMax.to(this.$refs.events, 1, {
              height: 0,
              clearProps: "height",
              ease: "Power4.easeOut"
          }),
          this.$refs.programbigitem.classList.remove("active"),
          this.eventsOpen = !1
      }
  }
}
...
, function(e, t, n) {
  ...
  class u extends (Object(i.a)()) {
      init() {
          l.a.load(),
          document.querySelector(".canvas").appendChild(s.a.domElement)
      }
      onRaf() {
          a.a.render(r.a, o.a)
      }
...
, function(e, t, n) {
  ...
  t.default = class extends i.Component {
      ...
      init() {
          if (!s.a.dom)
              return void document.documentElement.classList.add("show");
          new (0,
          n(63).default)
      }
      destroy() {}
...
, function(e, t, n) {
  ...
  t.default = class extends i.Component {
      ...
      open(e) {
          if (e && e.preventDefault(),
          this.isAnimating || this.isOpen)
              return;
          this.isAnimating = !0,
          this.$el.classList.add("open"),
          s.TweenMax.killTweensOf(this.$refs.content);
          const t = new s.TimelineMax({
              onComplete: ()=>{
                  this.isOpen = !0,
                  this.isAnimating = !1,
